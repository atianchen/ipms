...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    created: function created() {
        ...
        $.post(url, param).done(function (rs) {
            ...
            if (rs.person.lastProjId) _self.taskId = rs.person.lastProjId;
            _self.status = "record";
    ...
    methods: {
        showCreateTime: function showCreateTime() {
            if (this.record.createDate) return moment(this.record.createDate * 1000).format("DD/MM/YYYY, h:mm:ss");else return moment(this.record.modifiedDate * 1000).format("DD/MM/YYYY, h:mm:ss");
        },
        entry: function entry(period, event) {
            var _self = this;
