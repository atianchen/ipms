...
export default {
    ...
    created:function(){
        let _self=this;
        $.post("/rpt/CashinActualReport").done((rs)=>{_self.gridData=rs.data;_self.page=rs.page;_self.entrydate1=rs.entrydate1;_self.entrydate2=rs.entrydate2;});
    },
    methods: {
        ...
        pageSearch: function () {
            ...
            $.post("/rpt/CashinActualReport", param).done((rs) => {
