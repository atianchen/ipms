<template>
    <div class="grid">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Role <small>Manage Role Info</small></h2>
...
export default {
  ...
  created:function(){
        let _self=this;
        $.post("/setting/role/list").done((rs)=>{_self.gridData=rs.data;_self.page=rs.page;}).fail(function(){})
  },
  methods: {
        createRole:function(ev){this.$router.push("/setting/roleAdd");},
        itemClick: function (param) {
            this.$router.push({ name:'roleEdit', params: { roleId: param }})
         },
         ...
         {
            let _self=this;
            $.post("/setting/role/list",{q:util.qfilter(this.q),page:this.page}).done((rs)=>{_self.gridData=rs.data;_self.page=rs.page;}).fail(function(){})
         }
    },
    components: {
     'hy-grid': Grid,
